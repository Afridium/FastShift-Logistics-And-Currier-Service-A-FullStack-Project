...
const Register = () => {
    ...
    const {registerUsingEmailAndPassword, signInWithGoogle} = useAuth();
        ...
        <div className="hero min-h-screen lg:w-[80%] lg:mx-auto">
            <div className="hero-content w-full flex-col justify-center items-center">
                <div className='w-[70%] mx-auto'>
                   <h3 className='text-4xl text-(--color-title) font-extrabold mb-2.5'>Create An Account</h3>
                   <p>Register with FastShip</p>
                </div>
                <div className="card bg-base-100 w-full shrink-0">
                    <div className="card-body w-[70%] mx-auto p-0">
                        ...
                        <button onClick={handleGoogleRegistration} className="btn bg-white text-black">
