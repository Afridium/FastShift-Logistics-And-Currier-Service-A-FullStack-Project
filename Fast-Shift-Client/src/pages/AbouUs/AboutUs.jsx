...
const AboutUs = () => {
    return (
        <div className='bg-white my-11 rounded-3xl p-5 lg:p-10 lg:px-20'>
            ...
            <div className="tabs">
                <input type="radio" name="my_tabs_1" placeholder='Mission' className="tab text-xl checked:font-bold checked:text-amber-900" aria-label="Story" defaultChecked />
                ...
                <input type="radio" name="my_tabs_1" className="tab text-xl checked:font-bold checked:text-amber-900" aria-label="Mission" />
                ...
                <input type="radio" name="my_tabs_1" className="tab text-xl checked:font-bold checked:text-amber-900" aria-label="Success" />
                <div className='tab-content p-6'>
                ...
                <input type="radio" name="my_tabs_1" className="tab text-xl checked:text-amber-900 checked:font-bold" aria-label="Teams and Others" />
                <div className='tab-content p-6'>
